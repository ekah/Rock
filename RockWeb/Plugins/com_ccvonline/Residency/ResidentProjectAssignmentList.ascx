<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResidentProjectAssignmentList.ascx.cs" Inherits="RockWeb.Plugins.com_ccvonline.Residency.ResidentProjectAssignmentList" %>
