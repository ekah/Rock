<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResidencyCompetencyPersonProjectList.ascx.cs" Inherits="com.ccvonline.Blocks.ResidencyCompetencyPersonProjectList" %>
