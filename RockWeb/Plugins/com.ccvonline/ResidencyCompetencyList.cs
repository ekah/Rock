...
namespace com.ccvonline.Blocks
{
    ...
    /// </summary>
    [DetailPage]
    public partial class ResidencyCompetencyList : RockBlock
    {
        ...
        private void BindGrid()
        {
            ...
            {
                gList.DataSource = residencyCompetencyService.Queryable().Sort( sortProperty ).ToList();
            }
            else
            {
                gList.DataSource = residencyCompetencyService.Queryable()
