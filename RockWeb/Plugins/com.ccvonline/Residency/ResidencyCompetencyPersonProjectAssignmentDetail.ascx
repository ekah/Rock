<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResidencyCompetencyPersonProjectAssignmentDetail.ascx.cs" Inherits="RockWeb.Blocks.Administration.ResidencyCompetencyPersonProjectAssignmentDetail" %>
