<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProjectPointOfAssessmentDetail.ascx.cs" Inherits="RockWeb.Plugins.com.ccvonline.Residency.ProjectPointOfAssessmentDetail" %>
