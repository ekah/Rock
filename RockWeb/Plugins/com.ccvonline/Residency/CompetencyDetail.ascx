<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompetencyDetail.ascx.cs" Inherits="RockWeb.Plugins.com.ccvonline.Residency.CompetencyDetail" %>
            ...
            <div id="pnlEditDetails" runat="server" class="well">
                ...
                <fieldset>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            <Rock:DataTextBox ID="tbGoals" runat="server" SourceTypeName="com.ccvonline.Residency.Model.ResidencyCompetency, com.ccvonline.Residency" PropertyName="Goals" TextMode="MultiLine" Rows="5" CssClass="input-xlarge" />
