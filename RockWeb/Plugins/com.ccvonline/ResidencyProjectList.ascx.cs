...
namespace com.ccvonline.Blocks
{
    ...
    /// </summary>
    [DetailPage]
    public partial class ResidencyProjectList : RockBlock
    {
        ...
        {
            NavigateToDetailPage( "residencyProjectId", 0 );
        }
        ...
        {
            NavigateToDetailPage( "residencyProjectId", (int)e.RowKeyValue );
        }
        ...
        private void BindGrid()
        {
            ...
            {
                gList.DataSource = residencyProjectService.Queryable().Sort( sortProperty ).ToList();
            }
            else
            {
                gList.DataSource = residencyProjectService.Queryable().OrderBy( s => s.Name ).ToList();
            }
